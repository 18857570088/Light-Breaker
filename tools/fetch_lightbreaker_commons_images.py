...
CATEGORIES = [
    ...
    },
    {
        ...
        "nameZh": "萌宠",
        "nameEn": "Cute Pets",
        "description": "猫、狗、兔、仓鼠等轻松可爱的横屏宠物照片。",
        "queries": [
            "domestic cat",
            "kitten cat photo",
    ...
    },
    {
        ...
        "description": "太空、星云、火箭、宇航员、火星地貌与未来感建筑照片。",
        "queries": [
            "NASA nebula space photo landscape filetype:bitmap",
            "rocket launch night photo landscape filetype:bitmap",
            "astronaut spacewalk photo landscape filetype:bitmap",
            "Mars panorama landscape photo filetype:bitmap",
            "International Space Station Earth photo landscape filetype:bitmap",
            "Milky Way observatory photo landscape filetype:bitmap",
            "radio telescope stars night photo landscape filetype:bitmap",
            "futuristic architecture night photo landscape filetype:bitmap",
            "space shuttle launch photo landscape filetype:bitmap",
            "planet Earth from space photo landscape filetype:bitmap",
        ],
    },
]
