...
def add_cover(doc: Document) -> None:
    ...
    add_table(
        ...
        [
            ...
            ["推荐设备", "Android 手机、BOXING#PL 左手手套、BOXING#PR 右手手套"],
        ],
        widths=[3.5, 11.5],
    )
    doc.add_page_break()
...
def build_manual() -> None:
    ...
    add_bullets(
        ...
        [
            ...
            "打开拳击手套电源，确认设备名称以 BOXING#PL 开头的是左手，以 BOXING#PR 开头的是右手。",
    ...
    add_numbered(
        ...
        [
            ...
            "在设备列表中选择 BOXING#PL... 或 BOXING#PR... 设备。",
    ...
    add_table(
        ...
        [
            ...
            ["扫描中", "正在查找 BOXING#PL/PR 设备。", "等待设备出现，保持手套靠近手机。"],
    ...
    add_table(
        ...
        [
            ...
            ["只连接到一只手套", "另一只手套未开机或未进入广播状态。", "检查设备名称是否为 BOXING#PL 或 BOXING#PR；重启未出现的手套。"],
    ...
    add_table(
        ...
        [
            ...
            ["支持图片类型", "自然风光、名画再现、城市建筑、抽象艺术"],
            ["蓝牙设备名", "左手 BOXING#PL...；右手 BOXING#PR..."],
        ],
        widths=[3.5, 11.5],
    )
    add_note(
